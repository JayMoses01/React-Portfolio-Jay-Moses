            ...
            <div className="container ml-0">
                <div className="columns ml-0">
                    ...
                    <div class="column is-10 ml-0 box">
                        ...
                        <a href="https://slither-in.herokuapp.com/"></a>
                        <img src="./assets/slither-in.png" alt="Slither-In">
                        </img>
                    </div>
            ...
            <div className="container ml-0">
                <div className="columns ml-0">
                    ...
                    <div className="column is-10 ml-0 box">
                        ...
                        <a href="https://seyaryu.github.io/National-Park-Project/"></a>
                        <img src="./assets/national-park-search-main.png" alt="National Parks Search">
                        </img>
                    </div>
                </div>
            </div>
                    ...
                    <div className="column is-10 ml-0 box">
                        ...
                        <div className="is-flex is-justify-content-center">
                            <a href="https://drive.google.com/file/d/10z2v4_x1kqpTTmM7qFNruR_o8t9npst4/view?usp=sharing">
                                <img src="./assets/employee-tracker-01.png" alt="Employee Management System"/>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div className="columns ml-0">
                    ...
                    <div className="column is-10 ml-0 box">
                        ...
                        <a href="https://jaymoses01.github.io/hw-06-weather-dashboard/">
                            <img src="./assets/weather-dashboard.png" alt="Weather Dashboard"/>
                        </a>
                    </div>
                </div>
            </div>
